...
<button type="button" class="btn-close" data-bs-dismiss="alert"></button> <strong>Versión de GIT</strong> Puede que la versión que instales no sea la misma que muestro acá, pero la instalación no debería ser muy distinta.
:::
